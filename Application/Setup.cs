...
using Sync.Application.Users.CreateUser;
using Sync.Application.WebApp;
...
public static class Setup
{
    public static void AddServices(IServiceCollection services)
    {
        ...
        services.AddSingleton<IndexHandler>();
    ...
    {
        app.MapGet("/", [AllowAnonymous] (IndexHandler handler) => handler.Handle());
